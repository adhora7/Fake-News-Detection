...
# A machine learning project that detects \*\*fake vs real news articles\*\* using \*\*Natural Language Processing (NLP)\*\* and \*\*Python\*\*. The model is trained on labeled news data and achieves strong classification performance.
